...
public class HazardCurveCalcGateway {
	...
	private double timespan = 30d; //default timespan is 30 years,

    // public HazardCurveCalcGateway() {
    // 	this.timespan = 30d;
    // }

	public static void main(String[] args) {
		HazardCurveCalcGateway app = new HazardCurveCalcGateway();
	...
	public void execute(Float lon, Float lat) {
		...
		// ERFs also have time spans, which include the forecast duration.
		TimeSpan timeSpan = erf.getTimeSpan();
		timeSpan.setDuration(this.timespan); // years
